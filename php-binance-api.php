...
class API
{
    ...
    {
        $params["sapi"] = true;
		return $this->httpRequest("v1/capital/config/getall", 'GET', $params, true);
    }

    public function networkDepositAddress(string $coin, string $network)
    {
        $params = [
            "sapi" => true,
            "coin" => $coin,
